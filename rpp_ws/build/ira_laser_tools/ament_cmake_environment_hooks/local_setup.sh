...
: ${AMENT_CURRENT_PREFIX:="/home/rpp/rpp_ws/install/ira_laser_tools"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ira_laser_tools/environment/library_path.sh"
