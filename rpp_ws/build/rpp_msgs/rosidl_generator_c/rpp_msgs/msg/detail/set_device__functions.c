...
rpp_msgs__msg__SetDevice__create()
{
  ...
  rpp_msgs__msg__SetDevice * msg = (rpp_msgs__msg__SetDevice *)allocator.allocate(sizeof(rpp_msgs__msg__SetDevice), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rpp_msgs__msg__SetDevice));
  bool success = rpp_msgs__msg__SetDevice__init(msg);
  if (!success) {
...
rpp_msgs__msg__SetDevice__destroy(rpp_msgs__msg__SetDevice * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rpp_msgs__msg__SetDevice__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rpp_msgs__msg__SetDevice__Sequence__init(rpp_msgs__msg__SetDevice__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rpp_msgs__msg__SetDevice * data = NULL;

  if (size) {
    data = (rpp_msgs__msg__SetDevice *)allocator.zero_allocate(size, sizeof(rpp_msgs__msg__SetDevice), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rpp_msgs__msg__SetDevice__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rpp_msgs__msg__SetDevice__fini(&data[i - 1]);
      }
...
rpp_msgs__msg__SetDevice__Sequence__fini(rpp_msgs__msg__SetDevice__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rpp_msgs__msg__SetDevice__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rpp_msgs__msg__SetDevice__Sequence * array = (rpp_msgs__msg__SetDevice__Sequence *)allocator.allocate(sizeof(rpp_msgs__msg__SetDevice__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rpp_msgs__msg__SetDevice__Sequence__init(array, size);
  if (!success) {
...
rpp_msgs__msg__SetDevice__Sequence__destroy(rpp_msgs__msg__SetDevice__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rpp_msgs__msg__SetDevice__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rpp_msgs__msg__SetDevice__Sequence__are_equal(const rpp_msgs__msg__SetDevice__Sequence * lhs, const rpp_msgs__msg__SetDevice__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rpp_msgs__msg__SetDevice__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rpp_msgs__msg__SetDevice__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rpp_msgs__msg__SetDevice);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rpp_msgs__msg__SetDevice * data =
      (rpp_msgs__msg__SetDevice *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rpp_msgs__msg__SetDevice__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rpp_msgs__msg__SetDevice__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rpp_msgs__msg__SetDevice__copy(
