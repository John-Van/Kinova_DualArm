...
class Metaclass_MotorState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rpp_msgs.msg import SingleMotorState
            if SingleMotorState.__class__._TYPE_SUPPORT is None:
                SingleMotorState.__class__.__import_type_support__()
...
class MotorState(metaclass=Metaclass_MotorState):
    ...
    _fields_and_field_types = {
        'motor_states': 'rpp_msgs/SingleMotorState[4]',
        'ts': 'int64',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['rpp_msgs', 'msg'], 'SingleMotorState'), 4),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_states = kwargs.get(
            'motor_states',
            [SingleMotorState() for x in range(4)]
        )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) == 4 and
                 all(isinstance(v, SingleMotorState) for v in value) and
                 True), \
                "The 'motor_states' field must be a set or sequence with length 4 and each value of type 'SingleMotorState'"
