...
bool rpp_msgs__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rpp_msgs.msg._motor_state.MotorState", full_classname_dest, 36) == 0);
  }
  rpp_msgs__msg__MotorState * ros_message = _ros_message;
  {  // motor_states
    ...
    Py_ssize_t size = 4;
    rpp_msgs__msg__SingleMotorState * dest = ros_message->motor_states;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rpp_msgs__msg__single_motor_state__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * rpp_msgs__msg__motor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rpp_msgs.msg._motor_state");
  ...
  {  // motor_states
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = rpp_msgs__msg__single_motor_state__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
