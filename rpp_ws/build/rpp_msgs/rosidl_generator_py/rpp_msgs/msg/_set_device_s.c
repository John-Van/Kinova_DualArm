...
bool rpp_msgs__msg__set_device__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rpp_msgs.msg._set_device.SetDevice", full_classname_dest, 34) == 0);
  }
  rpp_msgs__msg__SetDevice * ros_message = _ros_message;
  {  // control_mode
...
{
  /* NOTE(esteve): Call constructor of SetDevice */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rpp_msgs.msg._set_device");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetDevice");
