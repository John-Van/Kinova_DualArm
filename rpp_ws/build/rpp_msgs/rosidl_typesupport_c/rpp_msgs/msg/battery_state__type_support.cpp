...
static const _BatteryState_type_support_symbol_names_t _BatteryState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rpp_msgs, msg, BatteryState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rpp_msgs, msg, BatteryState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rpp_msgs, msg, BatteryState)() {
  return &::rpp_msgs::msg::rosidl_typesupport_c::BatteryState_message_type_support_handle;
}
