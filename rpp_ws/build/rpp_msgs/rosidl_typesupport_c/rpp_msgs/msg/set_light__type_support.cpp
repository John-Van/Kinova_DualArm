...
static const _SetLight_type_support_symbol_names_t _SetLight_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rpp_msgs, msg, SetLight)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rpp_msgs, msg, SetLight)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rpp_msgs, msg, SetLight)() {
  return &::rpp_msgs::msg::rosidl_typesupport_c::SetLight_message_type_support_handle;
}
