...
#include "rpp_msgs/msg/detail/motor_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rpp_msgs/msg/detail/single_motor_state__functions.h"  // motor_states
...
using _MotorState__ros_msg_type = rpp_msgs__msg__MotorState;
  ...
  // Field name: motor_states
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rpp_msgs, msg, SingleMotorState
      )()->data);
    size_t size = 4;
...
size_t get_serialized_size_rpp_msgs__msg__MotorState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorState__ros_msg_type * ros_message = static_cast<const _MotorState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name motor_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rpp_msgs__msg__SingleMotorState(
...
static uint32_t _MotorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rpp_msgs__msg__MotorState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rpp_msgs
size_t max_serialized_size_rpp_msgs__msg__MotorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: motor_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rpp_msgs__msg__SingleMotorState(
  ...
  if (is_plain) {
    ...
    using DataType = rpp_msgs__msg__MotorState;
    is_plain =
      (
...
static size_t _MotorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rpp_msgs__msg__MotorState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rpp_msgs, msg, MotorState)() {
