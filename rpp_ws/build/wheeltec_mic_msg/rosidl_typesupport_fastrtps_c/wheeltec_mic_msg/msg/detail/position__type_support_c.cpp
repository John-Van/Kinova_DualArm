...
#include "wheeltec_mic_msg/msg/detail/position__rosidl_typesupport_fastrtps_c.h"
...
using _Position__ros_msg_type = wheeltec_mic_msg__msg__Position;
...
size_t get_serialized_size_wheeltec_mic_msg__msg__Position(
  const void * untyped_ros_message,
...
static uint32_t _Position__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wheeltec_mic_msg__msg__Position(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wheeltec_mic_msg
size_t max_serialized_size_wheeltec_mic_msg__msg__Position(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wheeltec_mic_msg__msg__Position;
    is_plain =
      (
...
static size_t _Position__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wheeltec_mic_msg__msg__Position(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wheeltec_mic_msg, msg, Position)() {
