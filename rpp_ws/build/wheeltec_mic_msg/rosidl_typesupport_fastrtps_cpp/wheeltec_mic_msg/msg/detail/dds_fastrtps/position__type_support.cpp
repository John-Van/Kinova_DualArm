...
#include "wheeltec_mic_msg/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wheeltec_mic_msg::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wheeltec_mic_msg::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wheeltec_mic_msg::msg::Position *>(
    untyped_ros_message);
...
{
  return &wheeltec_mic_msg::msg::typesupport_fastrtps_cpp::_Position__handle;
}
