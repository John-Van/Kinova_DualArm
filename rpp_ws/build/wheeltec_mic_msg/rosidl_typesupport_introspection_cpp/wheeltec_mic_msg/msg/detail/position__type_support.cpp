...
{
  new (message_memory) wheeltec_mic_msg::msg::Position(_init);
}

void Position_fini_function(void * message_memory)
{
  auto typed_message = static_cast<wheeltec_mic_msg::msg::Position *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Position_message_member_array[3] = {
  {
    ...
    offsetof(wheeltec_mic_msg::msg::Position, angle_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wheeltec_mic_msg::msg::Position, angle_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wheeltec_mic_msg::msg::Position, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Position_message_members = {
  ...
  3,  // number of fields
  sizeof(wheeltec_mic_msg::msg::Position),
...
get_message_type_support_handle<wheeltec_mic_msg::msg::Position>()
{
  return &::wheeltec_mic_msg::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wheeltec_mic_msg, msg, Position)() {
  return &::wheeltec_mic_msg::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
