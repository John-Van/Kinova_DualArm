...
set_target_properties(serial PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libserial.so"
  IMPORTED_SONAME_DEBUG "libserial.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS serial )
list(APPEND _IMPORT_CHECK_FILES_FOR_serial "${_IMPORT_PREFIX}/lib/libserial.so" )
