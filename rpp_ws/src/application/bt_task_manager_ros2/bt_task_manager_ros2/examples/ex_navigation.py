...
import py_trees
import py_trees_ros
from bt_task_manager_ros2.navigation import NavigationToPose
...
def create_queue_tree():
    ...
    main_sequence.add_children(
        [
            NavigationToPose("navigation_1", [-0.0, -0.35, 0]),
            # NavigationToPose("navigation_2", [2.0, 0.0, 0]),
            # NavigationToPose("navigation_3", [0.0, 2.0, 0]),
            # NavigationToPose("navigation_4", [0.0, -2.0, 0]),
        ]
    )
