...
class MoveIt2:
    ...
    @property
    def cartesian_speed_limited_link(self) -> float:
        return self.__cartesian_path_request.request.cartesian_speed_limited_link

    @cartesian_speed_limited_link.setter
    def cartesian_speed_limited_link(self, value: float):
        self.__cartesian_path_request.cartesian_speed_limited_link = value

    @property
    def max_cartesian_speed(self) -> float:
        return self.__cartesian_path_request.request.max_cartesian_speed

    @max_cartesian_speed.setter
    def max_cartesian_speed(self, value: float):
        self.__cartesian_path_request.max_cartesian_speed = value
