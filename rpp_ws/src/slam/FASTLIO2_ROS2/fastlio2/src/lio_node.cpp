...
public:
    ...
    void loadParameters()
    {
        this->declare_parameter("config_path", "/home/hfsh/fastlio2_ws/src/FASTLIO2_ROS2/fastlio2/config/lio.yaml");
    ...
    void lidarCB(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
    {
        ...
        cloud = Utils::convertAndComputeNormals(*msg, m_builder_config.lidar_filter_num, m_builder_config.lidar_min_range, m_builder_config.lidar_max_range);
...
private:
    std::shared_ptr<void> m_lidar_sub;
