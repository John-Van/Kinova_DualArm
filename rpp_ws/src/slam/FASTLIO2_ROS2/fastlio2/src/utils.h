...
public:
    ...
    static pcl::PointCloud<pcl::PointXYZINormal>::Ptr convertAndComputeNormals(const sensor_msgs::msg::PointCloud2& input_cloud_msg,int filter_num, double min_range, double max_range);
};